...
def evaluate(code):
    reply = run(["gdbus", "call", "--session", "--dest", "org.gnome.Shell",
...
if __name__ == "__main__":
    ...
    for cycle in range(4):
        ...
        evaluate("global.get_window_actors().find(a=>a.meta_window.title==='Corner fixture').meta_window.activate(global.get_current_time());true")
        time.sleep(.4)
