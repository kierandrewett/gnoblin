...
export default class extends Extension {
    enable() {
        ...
        const panelData = Main.layoutManager._trackedActors.find(({ actor }) => actor === Main.layoutManager.panelBox);
        ...
        if (panelData?.affectsStruts !== expectedReactive || panelData?.affectsInputRegion !== expectedReactive) {
            throw new Error(
