...
The interactive Bingux SSD regression also verifies that compositor hover
over a real control changes rendered pixels, and that two titlebar
double-clicks toggle maximize then restore.

The earlier explanation that the hidden host had
