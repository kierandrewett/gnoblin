...
Stock is official Fedora Shell 49.9/Mutter 49.7, extracted from signed RPMs
and run in a private mount namespace with its own libraries and resources.

The system GNOME installation was not used as stock because it is Gnoblin-patched.
