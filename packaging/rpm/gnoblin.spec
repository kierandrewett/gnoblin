...
BuildArch:      noarch
Requires:       gnoblin-gsettings-desktop-schemas >= 0.1.8
Requires:       gnoblin-mutter >= 0.1.8
Requires:       gnoblin-session >= 0.1.8
Requires:       gnoblin-shell >= 0.1.8
...
Requires:       gnoblin-mutter = 51.0-27.gnoblin%{?dist}
