            ...
            items: [
              ...
              { text: 'compositor', link: '/config/configure/compositor' },
              {
                ...
                items: [
                  ...
                  { text: 'tablets', link: '/config/configure/input/tablets' },
                  { text: 'styluses', link: '/config/configure/input/styluses' },
                  { text: 'orientation_lock', link: '/config/configure/input/orientation_lock' },
                ],
              },
