...
| Symptom                                                | Check                                                                                                                                                 |
| ------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| `gnoblinctl window list` cannot connect                | Run `gnoblinctl status --json`; inspect `windowControlError` and the socket path. See [connection details](gnoblinctl.md#connection-problems).        |
