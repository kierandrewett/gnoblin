...
GnoblinPermission gnoblin_permission_check(GDBusMethodInvocation* invocation,
    ...
    reply = g_dbus_connection_call_sync(
        g_dbus_method_invocation_get_connection(invocation), "org.gnoblin.Shell",
        "/org/gnoblin/Shell", "org.gnoblin.Shell", "CheckPermission",
    ...
    else if (g_str_equal(level, "allow") && identity)
