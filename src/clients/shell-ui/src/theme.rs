...
pub fn shell_chrome(dark: bool) -> ShellChrome {
    ...
    let mut chrome = if dark {
        ShellChrome {
            ...
            dock_bg: argb(0xc4, 0x20, 0x21, 0x22),
            dock_border: argb(0x18, 0xff, 0xff, 0xff),
            ...
            menu_bg: argb(0xed, 0x26, 0x26, 0x28),
        ...
        ShellChrome {
            ...
            dock_bg: argb(0xe3, 0xf7, 0xf7, 0xf7),
            dock_border: argb(0x1a, 0x00, 0x00, 0x00),
            ...
            menu_bg: argb(0xf0, 0xfa, 0xfa, 0xfa),
