...
REQUIREMENTS = {
    "glib": {
        ...
        "floorSource": "nix/native-packages.nix:9",
    },
    "gjs": {
        "capability": "pkgconfig(gjs-1.0)",
        "minimum": "1.85.90",
        "declaredScope": "host-runtime-contract",
        "floorSource": "nix/native-packages.nix:10",
    },
    "wayland": {
        "capability": "pkgconfig(wayland-client)",
        "minimum": "1.26.0",
        "declaredScope": "host-runtime-contract",
        "floorSource": "nix/native-packages.nix:18",
    },
    "wayland-protocols": {
        ...
        "floorSource": "nix/native-packages.nix:74-78",
    },
    "libinput": {
        "capability": "pkgconfig(libinput)",
        "minimum": "1.30.0",
        "declaredScope": "host-runtime-contract",
        "floorSource": "nix/native-packages.nix:22",
    },
    "pipewire": {
        "capability": "pkgconfig(libpipewire-0.3)",
        "minimum": "1.4.0",
        "declaredScope": "host-runtime-contract",
        "floorSource": "nix/native-packages.nix:23",
    },
    "gtk4": {
