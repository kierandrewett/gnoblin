...
def render_arch(manifest: dict, source_sha256: str = "SKIP") -> str:
    ...
    return (
        ...
        '    cp -a "$_build_prefix/schemas/lib/girepository-1.0/." "$pkgdir$_prefix/lib/girepository-1.0/"\n'
        '    cp -a "$_build_prefix/schemas/share/glib-2.0/schemas/." "$pkgdir$_prefix/share/glib-2.0/schemas/"\n'
